...
```bash
https://github.com/entbappy/deeplearning-project-with-dvc-pipeline-deployed-in-aws
```
...
## 3. Create ECR repo to store/save docker image
    - Save the URI: 994385658056.dkr.ecr.us-east-1.amazonaws.com/chicken
